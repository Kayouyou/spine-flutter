...
mixin _$HomeData {
  ...
  String get sections => throw _privateConstructorUsedError;
...
abstract class $HomeDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String sections, String? banner});
}
...
class _$HomeDataImpl implements _HomeData {
  const _$HomeDataImpl(
      {required this.title, required this.sections, this.banner});
  ...
  @override
  String toString() {
    return 'HomeData(title: $title, sections: $sections, banner: $banner)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, sections, banner);
...
abstract class _HomeData implements HomeData {
  const factory _HomeData(
      ...
      required final String sections,
      final String? banner}) = _$HomeDataImpl;
