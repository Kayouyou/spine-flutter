...
abstract class $LoginResultCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userId, String token, bool isNewUser});
}
...
class _$LoginResultImpl implements _LoginResult {
  const _$LoginResultImpl(
      {required this.userId, required this.token, this.isNewUser = false});
  ...
  @override
  String toString() {
    return 'LoginResult(userId: $userId, token: $token, isNewUser: $isNewUser)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, userId, token, isNewUser);
...
abstract class _LoginResult implements LoginResult {
  const factory _LoginResult(
      ...
      final bool isNewUser}) = _$LoginResultImpl;
